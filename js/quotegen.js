$(function(){
	var quotes = [
		...
		"I am so credible and so influential and so relevant that I will change things.","I’m the No. 1 living and breathing rock star.",
	...
	html = '<p class="description">'+quote+'</p>';
	html += '<p class="author">-Kanye West</p>';
	$('.quote').html(html);
});
